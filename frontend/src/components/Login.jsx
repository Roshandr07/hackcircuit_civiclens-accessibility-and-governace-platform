...
import { LogIn, User, Lock, Sparkles, ArrowLeft, AlertCircle } from 'lucide-react';
    ...
    >
      <div className="glass p-8 rounded-3xl border-emerald-500/20 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Log in to your CivicLens account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {isLoading ? <Sparkles className="animate-spin" /> : <LogIn size={20} />}
